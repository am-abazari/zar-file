...
export function MaterialIconThemeExe(props) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
             viewBox="0 0 32 32" {...props}>{/* Icon from Material Icon Theme by Material Extensions - https://github.com/material-extensions/vscode-material-icon-theme/blob/main/LICENSE */}
            <path fill="#e64a19"
                  d="M28 4H4a2 2 0 0 0-2 2v20a2 2 0 0 0 2 2h24a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2m0 22H4V10h24Z"/>
        </svg>
    )
}
...
export function MaterialIconThemeImage(props) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
             viewBox="0 0 16 16" {...props}>{/* Icon from Material Icon Theme by Material Extensions - https://github.com/material-extensions/vscode-material-icon-theme/blob/main/LICENSE */}
            <path fill="#26a69a"
...
export function MaterialIconThemeJson(props) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
             viewBox="0 -960 960 960" {...props}>{/* Icon from Material Icon Theme by Material Extensions - https://github.com/material-extensions/vscode-material-icon-theme/blob/main/LICENSE */}
            <path fill="#f9a825"
...
export function MaterialIconThemePdf(props) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
             viewBox="0 0 24 24" {...props}>{/* Icon from Material Icon Theme by Material Extensions - https://github.com/material-extensions/vscode-material-icon-theme/blob/main/LICENSE */}
            <path fill="#ef5350"
...
export function MaterialIconThemeVideo(props) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
             viewBox="0 0 32 32" {...props}>{/* Icon from Material Icon Theme by Material Extensions - https://github.com/material-extensions/vscode-material-icon-theme/blob/main/LICENSE */}
            <path fill="#ff9800"
                  d="m24 6l2 6h-4l-2-6h-3l2 6h-4l-2-6h-3l2 6H8L6 6H5a3 3 0 0 0-3 3v14a3 3 0 0 0 3 3h22a3 3 0 0 0 3-3V6Z"/>
        </svg>
    )
}
...
export function MaterialIconThemeTaskfile(props) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
            ...
            <path fill="#b2dfdb" d="M16 3L4 9l12 6l12-6z"/>
...
export function MaterialIconThemeMdsvex(props) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 32 32" {...props}>{/* Icon from Material Icon Theme by Material Extensions - https://github.com/material-extensions/vscode-material-icon-theme/blob/main/LICENSE */}<path fill="#ff5722" d="m14 10l-4 3.5L6 10H4v12h4v-6l2 2l2-2v6h4V10zm12 6v-6h-4v6h-4l6 8l6-8z" /></svg>
    )
}
...
export function MaterialIconThemeLicense(props) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16" {...props}>{/* Icon from Material Icon Theme by Material Extensions - https://github.com/material-extensions/vscode-material-icon-theme/blob/main/LICENSE */}<path fill="#ff5722" d="M8 1a5.5 5.5 0 0 0-4 9.26V15l4-1.5l4 1.5v-4.74A5.49 5.49 0 0 0 8 1m0 1.5a4 4 0 1 1 0 8a4 4 0 0 1 0-8m0 2a2 2 0 1 0 0 4a2 2 0 0 0 0-4" /></svg>
    )
}
...
export function MaterialIconThemeCss(props) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 32 32" {...props}>{/* Icon from Material Icon Theme by Material Extensions - https://github.com/material-extensions/vscode-material-icon-theme/blob/main/LICENSE */}<path fill="#7e57c2" d="M20 18h-2v-2h-2v2c0 .193 0 .703 1.254 1.033A3.345 3.345 0 0 1 20 22h2v2h2v-2c0-.388-.562-.851-1.254-1.034C20.356 20.34 20 18.84 20 18m-3.254 2.966C14.356 20.34 14 18.84 14 18h-2v-2h-2v8h2v-2h4v2h2v-2c0-.388-.562-.851-1.254-1.034" /><path fill="#7e57c2" d="M24 4H4v20a4 4 0 0 0 4 4h16.16A3.84 3.84 0 0 0 28 24.16V8a4 4 0 0 0-4-4m2 14h-2v-2h-2v2c0 .193 0 .703 1.254 1.033A3.345 3.345 0 0 1 26 22v2a2 2 0 0 1-2 2h-2a2 2 0 0 1-2-2a2 2 0 0 1-2 2h-2a2 2 0 0 1-2-2a2 2 0 0 1-2 2h-2a2 2 0 0 1-2-2v-8a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2Z" /></svg>
    )
}


const Category = {
    Exe : MaterialIconThemeExe,
    Typescript: MaterialIconThemeTypescript,
    Javascript: MaterialIconThemeJavascript,
    File: MaterialIconThemeTaskfile,
    Video: MaterialIconThemeVideo,
    Zip: MaterialIconThemeZip,
    Pdf: MaterialIconThemePdf,
    Json: MaterialIconThemeJson,
    Git: MaterialIconThemeGit,
    Image: MaterialIconThemeImage,
    Docker:MaterialIconThemeDocker,
    Markdown:MaterialIconThemeMdsvex,
    License:MaterialIconThemeLicense,
    Eslint:MaterialIconThemeEslint,
    ReactJsx: MaterialIconThemeReact,
    ReactTsx: MaterialIconThemeReactTs,
